...
public class CreditNote
{
    ...
    {
        return Result.FailIf(DueDate < IssueDate, $"CreditNote:{Reference} - DueDate should not be lower than IssueDate");
    }

    private Result CheckCloseDate()
    {
        return Result.FailIf(ClosedDate < IssueDate, $"CreditNote:{Reference} - ClosedDate should not be lower than IssueDate");
    }
}
